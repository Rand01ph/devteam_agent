...
DevTeam Agent is a team work management agent built with Claude Agent SDK. It integrates with GitLab and Jira to automatically generate and manage weekly/monthly reports for team members.
...
The project uses the Claude Agent SDK to create an interactive conversational agent with MCP (Model Context Protocol) tools.
